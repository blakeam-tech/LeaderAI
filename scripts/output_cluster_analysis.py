...
dataset = pd.read_excel(
    "/Users/blake/Downloads/Custom Leader AI response test output.xlsx",
    sheet_name="Sheet1",
)
...
unsatisfactory_answers = dataset[
    dataset["Response Score (1 to 10) 1 is poor and 10 is excellent"] < cutoff
]
reasons = unsatisfactory_answers["Additional Feedback"].fillna(
...
final_dataset = pd.concat(
    [unsatisfactory_answers, satisfactory_answers], ignore_index=True
)
